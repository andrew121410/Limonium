...
impl platform::IPlatform for MiraiAPI {
    fn get_download_link(&self, project: &String, version: &String, build: &String) -> String {
        ...
        // Example https://github.com/etil2jz/Mirai/raw/build/1.18.2/Mirai-1.18.2-R0.1-SNAPSHOT.jar
        let mut link = String::from("https://github.com/etil2jz/Mirai/raw/build/");
    ...
    fn get_jar_name(&self, _project: &String, version: &String, _build: &String) -> String {
        let mut jar_name = String::from("Mirai-");
        jar_name.push_str(&version);
        jar_name.push_str("-R0.1-SNAPSHOT.jar");
        return jar_name;
    }
