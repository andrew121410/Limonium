...
1. [Paper](https://github.com/PaperMC/Paper) -> `./limonium download paper 1.20.4`
2. [Purpur](https://github.com/PurpurMC/Purpur) -> `./limonium download purpur 1.20.4`
3. [Pufferfish](https://github.com/pufferfish-gg/Pufferfish) -> `./limonium download pufferfish 1.20.4`
4. [Geyser](https://github.com/GeyserMc/Geyser) -> `./limonium download geyser 2.1.0` (default is geyser-standalone)
6. [Spigot](https://hub.spigotmc.org/stash/projects/SPIGOT/repos/spigot/browse) -> `./limonium download spigot 1.20.4` (Not recommended)\
...
```
./limonium download paper 1.20.4
```

```
./limonium download paper 1.20.4 --o Paper.jar
```

```
./limonium download paper 1.20.4 --o ./mc-servers/hub/Paper.jar
```
